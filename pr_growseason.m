function indicator = pr_growseason(data, output)
...
indicator.units = 'Precip during growing season (mm)';
indicator.title = 'Precipitation total during growing season (mm)';
indicator.dates(y - min_year + 1, :) = [y 8 1];
